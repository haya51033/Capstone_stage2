...
public class BookFlightActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener{
    ...
    static final String SEATS_VALUE = "seats_value";
    static final String CLASS_VALUE = "class_value";
    ...
    protected void onSaveInstanceState(Bundle outState) {
       ...
       outState.putInt(SEATS_VALUE, seats);
       outState.putString(CLASS_VALUE, flightClass);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            ...
            seats = savedInstanceState.getInt(SEATS_VALUE);
            flightClass = savedInstanceState.getString(CLASS_VALUE);
                ...
                public void onClick(View v) {
                    if(thisUser != null)
                    {
                        ...
                        else
                        {
                            ...
                            Toast.makeText(getApplicationContext(),getResources().getText(R.string.selectFlightClass), Toast.LENGTH_LONG).show();
